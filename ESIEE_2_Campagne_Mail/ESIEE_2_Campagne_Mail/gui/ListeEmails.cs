	...
	public partial class ListeEmails : Form
	{
		...
		private void oldupdateListView()
		{
			...
			foreach (Contact contact in listeContact)
			{
				...
				ListViewItem listViewItem = ConvertContactToListViewItem(contact, nbItem.ToString());
		...
		private void updateListView()
		{
			...
			foreach (Contact contact in listeContactView)
			{
				...
				if (!listContactAdded.Contains(contact))
				{
					...
					listeItemsDansLaListeView.Add(ConvertContactToListViewItem(contact));
				}
			}
		...
		/// <summary>
		/// Convertis un Contact en élèment de la liste.
		/// </summary>
		private ListViewItem ConvertContactToListViewItem(Contact contact, string? itemText = "")
		{
			if (string.IsNullOrWhiteSpace(itemText))
			{
				itemText = contact.Id.ToString();
			}
